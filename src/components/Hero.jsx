        ...
        <div className="flex-1 text-center md:text-left">
          ...
          >
            ...
            <div className="flex items-center justify-center md:justify-start gap-5 mt-2">
              <a href="#" className="w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-[0_4px_14px_rgba(0,0,0,0.05)] border border-slate-100 text-slate-700 hover:text-blue-600 hover:shadow-[0_4px_14px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all">
                <FiGithub size={24} strokeWidth={2} />
              </a>
              <a href="#" className="w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-[0_4px_14px_rgba(0,0,0,0.05)] border border-slate-100 text-slate-700 hover:text-blue-600 hover:shadow-[0_4px_14px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all">
                <FiLinkedin size={24} strokeWidth={2} />
              </a>
              <a href="mailto:contact@example.com" className="w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-[0_4px_14px_rgba(0,0,0,0.05)] border border-slate-100 text-slate-700 hover:text-blue-600 hover:shadow-[0_4px_14px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all">
